...
import { ArrowLeft, Calendar, User, ChevronLeft, ChevronRight, Share2 } from 'lucide-react';
...
export default function AraYaziDetay({
  ...
  const shareTitle = encodeURIComponent(araYazi.baslik);

  // Benzer yazılar - aynı kategoriden, mevcut yazı hariç, max 3
  const benzerYazilar = tumAraYazilar
    .filter(y => y.kategori === araYazi.kategori && y.id !== araYazi.id)
    .slice(0, 3);
